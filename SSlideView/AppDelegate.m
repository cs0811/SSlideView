...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    BackViewController * vc = [BackViewController new];
...
- (BOOL)application:(UIApplication *)app openURL:(NSURL *)url options:(NSDictionary<UIApplicationOpenURLOptionsKey,id> *)options {
    ...
    if ([url.absoluteString hasPrefix:@"SSlideView://test"]) {
        [[[UIAlertView alloc] initWithTitle:url.absoluteString message:nil delegate:self cancelButtonTitle:@"cancel" otherButtonTitles: nil] show];
    }
